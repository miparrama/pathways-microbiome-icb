...
```{r}
# # Import all MSI-samples (n=103)
complete.msicohort = read_csv("resources/dMMR-MSIH-ICB-all.csv") %>%
  filter(msStatus == "MSI") # Confirmed to be MSI by WGS. 

immune_signatures = read_csv("resources/immune-signatures-cpm.csv") %>% 
...
drup.metadata = read_csv("resources/drup-gut-metadata.csv") %>%
